...
//		shape = new CompoundShape();
		...
		Body<?> compound = new DynamicBody(shape, -10.0f, 80.0f);
		compound.setRestitution(0.1f);
		world.add(compound);
		compound.setRotation(0.5f);
		...
		world.add(floor);
		Body<?> floor2 = new StaticBody(new Rectangle(10.0f, 100.0f), -105.0f, 0);
		floor.setRestitution(0.1f);
		world.add(floor2);
		Body<?> floor3 = new StaticBody(new Rectangle(10.0f, 100.0f), 105.0f, 0);
		floor.setRestitution(0.1f);
		world.add(floor3);
